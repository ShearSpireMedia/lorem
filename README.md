# Lorem Generator
> A handy program to generate nonsense greeking and random Shakespeare Sonnets to use in your layouts. A copy button is now included to put the text into the clipboard.
